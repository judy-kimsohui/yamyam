...
" 먹는 순간을 가볍게 기록하고, 기록을 습관과 성취로 연결하는 라이프로그 플랫폼 "
...
YamYamLog는 **음식 기록의 진입장벽을 낮추고, 기록을 커뮤니티로 연결하는** 풀스택 웹 서비스입니다.
...
![인프라 구성도](https://github.com/user-attachments/assets/fc2661a3-e346-45f1-9ece-9e6929b67f7e)
